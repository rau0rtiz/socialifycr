...
const WIDGET_CATALOG: WidgetDef[] = [
  ...
  { id: 'reservations-widget', name: 'Reservas (depósitos)', description: 'Gestión de espacios apartados con depósito ($200 default) por hasta 3 meses. Tarjetas con colores según urgencia.', icon: BookOpen, featureFlag: 'reservations_widget', section: 'ventas', clientSpecific: ['The Mind Coach', 'Hilda Lopez'], tags: ['reservas', 'depósitos', 'pipeline'] },
