          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                maxLength={100}
                className="h-12 md:h-14 rounded-xl border-2 border-gray-200 focus:border-[#FF6B35] text-sm md:text-base px-4 bg-white text-black placeholder:text-gray-400 funnel-autofill"
              />
            </div>
            <div className="space-y-1.5">
