    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Leads del Funnel</h1>
                ...
                filtered.map((lead) => (
                  <TableRow key={lead.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        style={{ borderColor: levelColors[lead.business_level], color: levelColors[lead.business_level] }}
                      >
