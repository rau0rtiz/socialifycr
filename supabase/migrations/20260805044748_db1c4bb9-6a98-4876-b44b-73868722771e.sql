...
DROP TRIGGER IF EXISTS sync_landing_lead_to_crm_trg ON public.funnel_leads;
CREATE TRIGGER sync_landing_lead_to_crm_trg
AFTER INSERT OR UPDATE OF answers ON public.funnel_leads
